...
## 207th Birthday Program PDF

The navigation now includes a highlighted **207th Birthday Program** button.

- Page route: `/207th-birthday-program`
- PDF file: `public/documents/vidyasagar-207th-birthday-program-2026.pdf`
- The page displays the program booklet in the browser's built-in PDF viewer and also provides **Open full screen** and **Download PDF** actions.

## Developer Credit

The website footer includes the developer credit:

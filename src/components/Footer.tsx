...
export default function Footer(){return <footer className="mt-24 bg-[#153f33] text-white">
 ...
 <div className="border-t border-white/10">
  <div className="container-page flex flex-col gap-2 py-5 text-xs text-white/50 sm:flex-row sm:justify-between">
   <span>© 2026 Vidyasagar Society Bangladesh — Demo website.</span>
   <span>Client demo · Verify all content before production.</span>
  </div>
  <div className="border-t border-white/10 bg-black/10">
   <div className="container-page py-4 text-center text-sm text-white/75">
    Developed By <span className="font-semibold text-emerald-200">Modern Dev Technologies</span>, Contact: <a href="tel:01316950214" className="font-semibold text-emerald-200 transition hover:text-white">01316950214</a>
   </div>
  </div>
 </div>
 </footer>}
